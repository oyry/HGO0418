...
class Variable(object):
    def Sdate(self):
        ...
        return sdate  # 格式2011-1-1

    def Start_Date(self):
        start_date = datetime.date.today().strftime('%Y-%m-%d')
        return start_date  # 格式2011-01-01
    ...
    def Names(self):
        xs = ['赵', '钱', '孙', '李', '周', '吴', '郑', '王', '冯', '陈', '褚', '卫', '蒋', '沈', '韩', '杨', '朱', '秦', '尤', '许', '何',
              ...
              '拓跋', '夹谷', '宰父', '穀梁', '晋楚', '闫法', '汝鄢', '涂钦', '段干', '百里', '东郭', '南门', '呼延', '归海', '羊舌', '微生', '岳帅',
              '缑亢', '况後', '有琴', '梁丘', '左丘', '东门', '西门', '商牟', '佘佴', '伯赏', '南宫', '墨哈', '谯笪', '年爱', '阳佟', '第五', '言福']
        xing = random.choice(xs)
        ming = "".join(chr(random.randint(0x4e00, 0x9fa5)))
        xm = xing + ming
        return xm